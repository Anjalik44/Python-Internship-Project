...
def add_task():
    ...
    if len(task_string) == 0:
        ...
        the_connection.commit()  # Commit after inserting
        list_update()
...
def delete_task():
    try:
        ...
        if the_value in tasks:
            ...
            the_connection.commit()  # Commit after deleting
            list_update()
    except:
...
def delete_all_tasks():
    ...
    if message_box:
        ...
        the_connection.commit()  # Commit after deleting all
        list_update()
...
def close():
    print(tasks)
    the_connection.commit()  # Ensure any remaining changes are committed
